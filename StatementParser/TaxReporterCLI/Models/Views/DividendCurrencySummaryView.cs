...
namespace TaxReporterCLI.Models.Views
{
    public class DividendCurrencySummaryView
    {
        ...
        public DividendCurrencySummaryView(IList<DividendTransactionView> transactions, RegionInfo country)
        {
            this.Country = country;
            this.Currency = transactions.FirstOrDefault().Transaction.Currency;

            var brokerTransactions = transactions.Where(i => (i.Transaction as DividendTransaction).TaxCountry == country);
